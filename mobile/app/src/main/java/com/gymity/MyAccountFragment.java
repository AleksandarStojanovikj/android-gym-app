...
import com.gymity.adapters.MyGymCardRecyclerViewAdapter;
import com.gymity.adapters.MyOfferCardRecyclerViewAdapter;
...
public class MyAccountFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.shr_my_account, container, false);
        setUpToolbar(view);
        setUpView(view);
        ...
        makeApiCallForMyOffers(view);
        makeApiCallForMyGyms(view);
    ...
    private void makeApiCallForMyOffers(final View view) {
        Call<List<OfferDto>> getMyOffers = userClient.getMyOffers(SaveSharedPreference.getUsername(getActivity()));
        getMyOffers.enqueue(new Callback<List<OfferDto>>() {
            @Override
    ...
    private void makeApiCallForMyGyms(final View view) {
        Call<List<Gym>> getMyGyms = userClient.getMyGyms(SaveSharedPreference.getUsername(getActivity()));

        getMyGyms.enqueue(new Callback<List<Gym>>() {
            @Override
            ...
            public void onFailure(Call<List<Gym>> call, Throwable t) {
                Toast.makeText(getContext(), call.request().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void setUpRecyclerViewOffers(View view) {
        ...
        MyOfferCardRecyclerViewAdapter adapter = new MyOfferCardRecyclerViewAdapter(offers);
    ...
    public void setUpRecyclerViewGyms(View view) {
        ...
        MyGymCardRecyclerViewAdapter adapter = new MyGymCardRecyclerViewAdapter(gyms);
        recyclerView.setAdapter(adapter);
        int smallPadding = getResources().getDimensionPixelSize(R.dimen.shr_staggered_product_grid_spacing_small);
        recyclerView.addItemDecoration(new ProductGridItemDecoration(smallPadding, smallPadding));
    }
